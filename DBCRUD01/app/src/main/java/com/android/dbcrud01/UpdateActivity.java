...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlAddress = "http://" + macIP + ":8080/test/studentUpdate.jsp?";
        ...
        edit_Code = findViewById(R.id.update_Edit_Code);
        edit_Name = findViewById(R.id.update_Edit_Name);
        edit_Dept = findViewById(R.id.update_Edit_Dept);
        edit_Phone = findViewById(R.id.update_Edit_Phone);
        ...
        btnUpdate = findViewById(R.id.update_Btn_OK);
    ...
    private void connectUpdateData(){
        try {
            CUDNetworkTask updateNetworkTask = new CUDNetworkTask(UpdateActivity.this, urlAddress);
